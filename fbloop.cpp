...
// source is a simple pattern of colors generated by a shader
// and filt2 is 
void seed() {
  filt2->bind();
  source->use();
...
// initialize an empty renderbuffer and draw its contents
// into `dest`
...
void load_shaders() {
  ...
  dest = new shader("passthru_pos", "newbanger", {});
  dest2 = new shader("passthru_pos", "newbanger2", {});
